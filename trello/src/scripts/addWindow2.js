            ...
            lists.forEach(list => {
                ...
                list.addEventListener('drop',  function ()
                {
                    if(document.querySelector('.one') === draggeaItem.parentNode)
                    {
                        ...
                        if (this.classList[1] === 'two') draggeaItem.children[0].style.background = '#106354';
                        if (this.classList[1] === 'three') draggeaItem.children[0].style.background = '#71441B';
                        ...
                        if (this.classList[1] === 'one') draggeaItem.children[0].style.background = '#1C5A7C';
                        if (this.classList[1] === 'three') draggeaItem.children[0].style.background = '#71441B';
